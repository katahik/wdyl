...
ActiveRecord::Schema.define(version: 2021_01_16_094235) do
  ...
  create_table "chosenitems", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "session_id"
    t.integer "item_id"
  ...
  create_table "sessions", primary_key: "session_id", id: :string, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "data"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
